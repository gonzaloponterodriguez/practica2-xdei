...
## Para **comenzar a desarrollar nuestra aplicación**:

* Crearemos una **carpeta nueva**, donde **copiaremos los archivos *docker-compose.yml, .env, services, import-data* del tutorial FIWARE NGSIv2 Subscriptions**.

* Con la ayuda del **agente en modo Plan, construiremos el *PRD.md*, *architecture.md* y *data\_model.md*** a partir del enunciado de la práctica, para lo cual será conveniente convertir a Markdown el enunciado, eliminando y ampliando los puntos que sean necesarios. Cuanto más detallados, concretos y específicos sean ***PRD.md*****, *architecture.md* y *data\_model.md***, mejor será la primera versión de la aplicación.  
* Pediremos al agente que cree un repo remoto en GitHub para nuestra aplicación y, a partir de los archivos

  ***PRD.md*****, *architecture.md* y *data\_model.md***, cree el **primer *issue* consistente en el plan de**

  **implementación de la primera versión de la aplicación**. Tanto para la elaboración de esos tres archivos como del plan de implementación recogido en este primer *issue*, nos ayudaremos del agente en modo Plan, solo cambiando a modo Agente cuando necesitemos que escriba los archivos.
